<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				<h1 class="site-title"><a href="/"><em class="fa fa-rocket"></em> for-web.ru</a></h1>
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="statistics.html"><em class="fa fa-bar-chart"></em> Статистика</a></li>
